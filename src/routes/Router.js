...
/***** Ui Elements ****/
const Settings = Loadable(lazy(() => import('../views/components/settings')));
const FinancialLeads = Loadable(lazy(() => import('../views/dashboards/FinancialLeads')));
const PendingLeads = Loadable(lazy(() => import('../views/dashboards/PendingLeads')));

const CompletedLeads = Loadable(lazy(() => import('../views/dashboards/CompletedLeads')));
...
{path : '/dashboards/minimal/financialleads',name:'Financial',exact:true,element:<FinancialLeads/>},
{path : '/dashboards/minimal/pendingleads',name:'Financial',exact:true,element:<PendingLeads/>},
{path : '/dashboards/minimal/completedleads',name:'Financial',exact:true,element:<CompletedLeads/>},
  ...
  },
  {
    ...
    element: <BlankLayout />,
    children: [
      // { path: '/', element: <Navigate to="/auth/loginformik" /> }, // Updated this line
  ...
  { path: '/registerformik/:id', element: <RegisterFormik /> },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'lockscreen', element: <LockScreen /> },
      { path: 'recoverpwd', element: <RecoverPassword /> },
      { path: 'clusterid', element: <ClusterId /> },
      // { path: 'reset-password/:token', element: <ResetPassword /> },
    ],
  },
];
