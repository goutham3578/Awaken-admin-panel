  ...
  const users = [
    {
      ...
      icon: Icon.Clock,
      title: 'Total Users',
      earn: state.dashboarddata?.data?.data[3].value ? state.dashboarddata?.data?.data[0].value : "0",
      color: 'primary',
    },
    {
      id: 2,
      ...
      earn: state.dashboarddata?.data?.data[2].value ? state.dashboarddata?.data?.data[16].value : "0",
      color: 'cyan',
    },
    {
      id: 3,
      ...
      earn: state.dashboarddata?.data?.data[1].value ? state.dashboarddata?.data?.data[20].value : "0",
      color: 'purple',
    },
    {
      id: 4,
      icon: Icon.Users,
      title: 'Total coupons',
      earn: state.dashboarddata?.data?.data[0].value ? state.dashboarddata?.data?.data[12].value : "0",
      color: 'warning',
    },
  ];
