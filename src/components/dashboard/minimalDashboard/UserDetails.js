    ...
    const users = [
        {
            ...
            icon: Icon.Clock,
            title: 'Today Users',
            earn: state.dashboarddata?.data?.data[3].value ? state.dashboarddata?.data?.data[3].value : "0",
            color: 'primary',
        },
        {
            id: 2,
            icon: Icon.Edit,
            title: 'Week Users',
            earn: state.dashboarddata?.data?.data[2].value ? state.dashboarddata?.data?.data[2].value : "0",
            color: 'cyan',
        },
        {
            id: 3,
            icon: Icon.Calendar,
            title: 'Month Users',
            earn: state.dashboarddata?.data?.data[1].value ? state.dashboarddata?.data?.data[1].value : "0",
            color: 'purple',
        },
        {
            id: 4,
            icon: Icon.Users,
            title: 'Total Users',
            earn: state.dashboarddata?.data?.data[0].value ? state.dashboarddata?.data?.data[0].value : "0",
            color: 'warning',
        },
    ];
