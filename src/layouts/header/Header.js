...
import { login, logout } from '../../store/api/auth'; // Import the login action from your Redux slice
...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <Nav className="me-auto d-none d-lg-flex bg" navbar>
      ...
      <div className="d-flex align-items-center">
        ...
        <UncontrolledDropdown className="mega-dropdown mx-1">
          <DropdownToggle className="bg-transparent border-0" color='black'>
            <Icon.Grid size={22} />
          </DropdownToggle>
          <DropdownMenu>
            <MegaDD />
        ...
        <UncontrolledDropdown>
          <DropdownToggle color='white'>
            <img src={dp} alt="profile" className="rounded-circle" width="30" />
          </DropdownToggle>
          <DropdownMenu className="ddWidth">
            <ProfileDD />
            <div className="p-2 px-3">
              <Button color="danger" size="sm" onClick={()=>dispatch(logout())}>
                Logout
              </Button>
            </div>
          </DropdownMenu>
